...
import type { PatientData } from "../../../models/patientBioData.js";
...
const addPatientImages = async (
  ...
  try {
    ...
    const filter: QueryFilter<PatientData> = {
      patientId: patientId,
    ...
    if (!patient) {
      ...
      return next(
        new  AppError("Patient doesn't exit or image limit exceeded", 409)
      );
    }
