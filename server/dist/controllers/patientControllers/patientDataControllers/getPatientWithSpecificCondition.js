...
const getPatientsWithSpecificConditionController = async (req, res, next) => {
    const condition = typeof req.params.condition === "string" ? req.params.condition.trim() : "";
    if (!condition) {
...
//# sourceMappingURL=getPatientWithSpecificCondition.js.map